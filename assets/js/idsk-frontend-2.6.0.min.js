!(function (e, t) {
  "object" == typeof exports && "undefined" != typeof module
    ...
    ? define("GOVUKFrontend", ["exports"], t)
    : t((e.GOVUKFrontend = {}));
})(this, function (e) {
  "use strict";
  function s(e, t) {
  ...
  (function (e) {
      ...
      "bind" in Function.prototype ||
        Object.defineProperty(Function.prototype, "bind", {
          value: function (t) {
            ...
            if (!i(f))
              throw new TypeError(
                "Function.prototype.bind called on incompatible " + f
              );
            for (
              var k,
                v = u.call(arguments, 1),
                b = m(0, f.length - v.length),
                y = [],
                g = 0;
              g < b;
              g++
            ...
            return (
              (k = Function(
                ...
                if (this instanceof k) {
                  var e = f.apply(this, h.call(v, u.call(arguments)));
                  return s(e) === e ? e : this;
                }
                return f.apply(t, h.call(v, u.call(arguments)));
              })),
              f.prototype &&
            ...
            return function (n, o) {
              ...
              return (
                ...
                (r.add = function () {
                  ...
                  for (var e, t, i = 0, s = e.length; i < s; ++i)
                    l[(t = e[i])] || (a.push(t), (l[t] = !0));
                  c !== a.length &&
                    ((c = a.length >>> 0),
                    "object" == typeof n[o]
                      ? (n[o].baseVal = a.join(" "))
                ...
                (r.remove = function () {
                  u.apply(r, (e = arguments));
                  for (var e, t = {}, i = 0, s = []; i < e.length; ++i)
                    (t[e[i]] = !0), delete l[e[i]];
        ...
        (function () {
          ...
          if (
            ...
            e.classList.constructor.prototype.add = function () {
              for (var e = arguments, t = arguments.length, i = 0; i < t; i++)
                s.call(this, e[i]);
            };
          }
        })(),
        ...
        (function () {
          if (!window.Element || window.HTMLElement) {
            ...
            var e,
              ...
              i = t.appendChild(document.createElement("iframe")).contentWindow
                .document,
              ...
              c = function (e, t) {
                ...
                if (1 === e.nodeType && e.constructor !== Element)
                  for (i in ((e.constructor = Element), l))
                    (s = l[i]), (e[i] = s);
                for (; (n = t && o[++r]); ) c(n, t);
                return e;
              },
            ...
            a.attachEvent("onpropertychange", function (e) {
              ...
              o() ||
                ((document.onreadystatechange = o), (e = setInterval(o, 25))),
    ...
    function (e) {
      ...
      ("document" in this &&
        ...
        (function (e) {
            ...
            u(
              ...
              function () {
                ...
                if (!(t[i] = !0) === d) {
                  for (
                    var s,
                      n = h.mirror || document.createElement("div"),
                      o = n.childNodes,
                      r = o.length,
                      a = 0;
                    a < r;
                  ...
                  (s = s || n.appendChild(document.createElement("div"))),
                    (e = DOMTokenList.call(s, t, c));
          ...
          h(e.Element, "classList", "className"),
            h(e.HTMLElement, "classList", "className"),
            h(e.HTMLLinkElement, "relList", "rel"),
            h(e.HTMLAnchorElement, "relList", "rel"),
            h(e.HTMLAreaElement, "relList", "rel");
        })(this);
    }.call(
      ("object" == typeof window && window) ||
        ("object" == typeof self && self) ||
    ...
    (n.prototype.initControls = function () {
      (this.$openAllButton = document.createElement("button")),
        ...
        (this.$openAllButton.innerHTML =
          'Otvoriť všetko <span class="govuk-visually-hidden">sections</span>'),
    ...
    (n.prototype.initSectionHeaders = function () {
      h(
        ...
        function (e, t) {
          ...
          this.initHeaderAttributes(i, t),
            this.setExpanded(this.isExpanded(e), e),
            i.addEventListener("click", this.onSectionToggle.bind(this, e)),
    ...
    (n.prototype.initHeaderAttributes = function (t, e) {
      ...
      r.setAttribute("type", "button"),
        r.setAttribute("id", this.moduleId + "-heading-" + (e + 1)),
        r.setAttribute("aria-controls", this.moduleId + "-content-" + (e + 1));
      ...
      r.addEventListener("focusin", function (e) {
        t.classList.contains(i.sectionHeaderFocusedClass) ||
          (t.className += " " + i.sectionHeaderFocusedClass);
      }),
      ...
      (c.className = this.iconClass),
        c.setAttribute("aria-hidden", "true"),
        n.appendChild(c);
    }),
    (n.prototype.onSectionToggle = function (e) {
    ...
    (n.prototype.setExpanded = function (e, t) {
      t
    ...
    (n.prototype.updateOpenAllButton = function (e) {
      var t = e ? "Zatvoriť všetky" : "Otvoriť všetky";
  ...
  (n.prototype.storeState = function (e) {
            ...
            (window.Event = Window.prototype.Event =
              function (e, t) {
                ...
                return (
                  ...
                  (i.bubbles = !(!t || t.bubbles === o) && t.bubbles),
                  (i.cancelable = !(!t || t.cancelable === o) && t.cancelable),
                  i
                );
              }),
              e &&
                    ...
                    function () {
                      ...
                      r._events || (r._events = {}),
                        r._events[e] ||
                          ...
                          (r._events[e].list = []),
                          r.attachEvent &&
                            r.attachEvent("on" + e, r._events[e])),
                  ...
                  Element.prototype.removeEventListener =
                    function () {
                      ...
                      t._events &&
                        ...
                        (t._events[i].list.splice(e, 1),
                        t._events[i].list.length ||
                          (t.detachEvent &&
                            t.detachEvent("on" + i, t._events[i]),
                          delete t._events[i]));
                    }),
                      ...
                      try {
                        ...
                        for (
                          ...
                          "_events" in (e.currentTarget = t) &&
                            "function" == typeof t._events[i] &&
                            t._events[i].call(t, e),
                            "function" == typeof t["on" + i] &&
                              t["on" + i].call(t, e),
                            (t =
                              9 === t.nodeType
                                ? t.parentWindow
  ...
  (a.prototype.handleInputs = function (e, i) {
    e.addEventListener("keypress", function (e) {
      var t = e.target;
      (13 !== e.keyCode && 32 !== e.keyCode) ||
        ("summary" === t.nodeName.toLowerCase() &&
          (e.preventDefault(), t.click ? t.click() : i(e)));
    }),
    ...
    (a.prototype.destroy = function (e) {
      e.removeEventListener("keypress"),
    ...
    (l.prototype.init = function () {
      ...
      if (this.$textarea) {
        ...
        if (
          (this.options.maxwords && (t = this.defaults.wordCountAttribute),
          (this.maxLength = e.getAttribute(t)),
          this.maxLength)
        ) {
          var i = this.createCountMessage.bind(this);
          if (((this.countMessage = i()), this.countMessage))
    ...
    (l.prototype.getDataset = function (e) {
      var t = {},
        i = e.attributes;
      if (i)
    ...
    (l.prototype.count = function (e) {
      ...
      this.options.maxwords
        ? (t = (e.match(/\S+/g) || []).length)
        : (t = e.length);
      return t;
    }),
    (l.prototype.createCountMessage = function () {
      var e = this.$textarea,
        t = e.id,
    ...
    (l.prototype.updateCountMessage = function () {
      ...
      s < (n * (t.threshold ? t.threshold : 0)) / 100
        ? (i.classList.add("govuk-character-count__message--disabled"),
          i.setAttribute("aria-hidden", !0))
        : (i.classList.remove("govuk-character-count__message--disabled"),
          i.removeAttribute("aria-hidden")),
        o < 0
          ? (e.classList.add("govuk-textarea--error"),
            i.classList.remove("govuk-hint"),
            i.classList.add("govuk-error-message"))
          : (e.classList.remove("govuk-textarea--error"),
            i.classList.remove("govuk-error-message"),
            i.classList.add("govuk-hint"));
      var r,
        a,
        l = "character";
      t.maxwords && (l = "word"),
        (l += -1 == o || 1 == o ? "" : "s"),
        (r = o < 0 ? "too many" : "remaining"),
        (a = Math.abs(o)),
        (i.innerHTML = "You have " + a + " " + l + " " + r);
    }),
    ...
    (d.prototype.init = function () {
      var e = this.$module;
      e &&
        (e.focus(), e.addEventListener("click", this.handleClick.bind(this)));
    }),
    (d.prototype.handleClick = function (e) {
      var t = e.target;
      this.focusTarget(t) && e.preventDefault();
    }),
    (d.prototype.focusTarget = function (e) {
    ...
    (d.prototype.getFragmentFromUrl = function (e) {
      return -1 !== e.indexOf("#") && e.split("#").pop();
    }),
    (d.prototype.getAssociatedLegendOrLabel = function (e) {
      ...
      return (
        document.querySelector("label[for='" + e.getAttribute("id") + "']") ||
        e.closest("label")
      );
    }),
    ...
    (p.prototype.toggleClass = function (e, t) {
      0 < e.className.indexOf(t)
        ? (e.className = e.className.replace(" " + t, ""))
        : (e.className += " " + t);
    }),
    (p.prototype.handleClick = function (e) {
      ...
      i &&
        ...
        s.setAttribute(
          "aria-hidden",
          "false" === s.getAttribute("aria-hidden")
        ));
    }),
    ...
    (m.prototype.setAttributes = function (e) {
      var t = document.querySelector("#" + e.getAttribute("aria-controls"));
      if (t && t.classList.contains("govuk-radios__conditional")) {
        var i = e.checked;
        e.setAttribute("aria-expanded", i),
          t.classList.toggle("govuk-radios__conditional--hidden", !i);
      }
    }),
    (m.prototype.handleClick = function (e) {
      var i = e.target;
      "radio" === i.type &&
        h(
    ...
    (f.prototype.onTabKeydown = function (e) {
      switch (e.keyCode) {
        case this.keys.left:
        case this.keys.up:
  ...
  function g(e) {
    (this.$module = e),
      (this.$items = e.querySelectorAll(".idsk-crossroad-title"));
  }
  function _(e) {
    this.$module = e;
  }
  ...
  function q(e) {
    (this.$module = e),
      ...
      (this.$sectionHeaderFocusedClass =
        "idsk-stepper__section-header--focused"),
  ...
  (k.prototype.handleKeyDown = function (e) {
    ...
    (k.prototype.debounce = function (e) {
      if ("true" === e.target.getAttribute("data-prevent-double-click"))
        return this.debounceFormSubmitTimer
          ? (e.preventDefault(), !1)
          : void (this.debounceFormSubmitTimer = setTimeout(
    ...
    (v.prototype.init = function () {
      var e = this.$module;
      if (e) {
        var t = e.querySelector("#idsk-feedback__question-bar #with-hint"),
        ...
        i && i.addEventListener("click", this.handleSendButtonClick.bind(this)),
          t &&
            t.addEventListener(
              "input",
    ...
    (v.prototype.handleSendButtonClick = function (e) {
      var t = this.$module.querySelector("#idsk-feedback__thanks");
      this.$module
        .querySelector("#idsk-feedback__content")
        .classList.add("idsk-feedback--hidden"),
        t.classList.remove("idsk-feedback--hidden");
    }),
    (v.prototype.handleRadioButtonClick = function (e) {
      var t = this.$module.querySelector("#idsk-feedback__question-bar");
      e.srcElement.classList.contains("idsk-feedback-textarea--show")
        ? (t.classList.add("idsk-feedback--open"),
          t.classList.remove("idsk-feedback--invisible"))
        : (t.classList.remove("idsk-feedback--open"),
          t.classList.add("idsk-feedback--invisible"));
    }),
    (v.prototype.handleStatusOfCharacterCountButton = function (e) {
      ...
      setTimeout(function () {
        t.classList.contains("govuk-textarea--error") ||
        i.classList.contains("govuk-error-message")
          ? (s.disabled = !0)
          : (s.disabled = !1);
      }, 300);
    }),
    (b.prototype.init = function () {
      ...
      if (e) {
        var t = e.querySelector("#idsk-footer-extended-feedback-yes-button"),
          ...
          c = e.querySelector("#footer-extended-up-button");
        t &&
          i &&
          s &&
          (t.addEventListener("click", this.handleYesButtonClick.bind(this)),
          i.addEventListener("click", this.handleNoButtonClick.bind(this)),
          s.addEventListener("click", this.handleErrorButtonClick.bind(this))),
          l &&
            l.addEventListener("click", this.handleErrorButtonClick.bind(this)),
          o &&
            o.addEventListener(
              "click",
    ...
    (b.prototype.handleSubmitButtonClick = function (e) {
      ...
      u(
        this.$module.querySelector("#idsk-footer-extended-feedback-content"),
        ...
        u(s, "idsk-footer-extended-heart"),
        u(n, "idsk-footer-extended-heart-visible"),
        u(o, "idsk-footer-extended-display-none");
    }),
    (b.prototype.handleStatusOfCharacterCountButton = function (e) {
      var t = this.$module.querySelector("#with-hint"),
        i = this.$module.querySelector("#with-hint-info"),
    ...
    (b.prototype.handleYesButtonClick = function (e) {
      var t = this.$module.querySelector("#idsk-footer-extended-help-form"),
        i = this.$module.querySelector("#idsk-footer-extended-error-form"),
        s = this.$module.querySelector("#idsk-footer-extended-info-question"),
        n = this.$module.querySelector("#idsk-footer-extended-heart");
    ...
    (b.prototype.handleNoButtonClick = function (e) {
      var t = this.$module.querySelector("#idsk-footer-extended-help-form"),
      ...
      u(
        ...
        u(i, "idsk-footer-extended-display-none"),
        u(t, "idsk-footer-extended-display-hidden"),
        u(t, "idsk-footer-extended-open");
    }),
    (b.prototype.handleErrorButtonClick = function (e) {
      ...
      u(
        ...
        u(s, "idsk-footer-extended-display-none"),
        i.classList.add("idsk-footer-extended-display-hidden"),
        i.classList.remove("idsk-footer-extended-open"),
        u(t, "idsk-footer-extended-display-hidden"),
        u(t, "idsk-footer-extended-open");
    }),
    (b.prototype.handleCloseErrorFormButtonClick = function (e) {
      var t = this.$module.querySelector("#idsk-footer-extended-error-form"),
        i = this.$module.querySelector("#idsk-footer-extended-feedback");
      u(
        this.$module.querySelector("#idsk-footer-extended-feedback-content"),
    ...
    (b.prototype.handleCloseHelpFormButtonClick = function () {
      ...
      u(
        ...
        u(t, "idsk-footer-extended-display-none"),
        u(e, "idsk-footer-extended-open"),
        u(e, "idsk-footer-extended-display-hidden");
    }),
    (b.prototype.scrollFunction = function () {
    ...
    (y.prototype.createCountMessage = function () {
      var e = this.$textarea,
        t = e.id,
        i = document.getElementById(t + "-info");
      return (
    ...
    (y.prototype.updateCountMessage = function () {
      ...
      t.maxwords && (r = "slov"),
        ...
        o < 0
          ? ((a = "-" + a),
            (i.innerHTML = "Prekročili ste maximálny počet znakov"))
          : (i.innerHTML = "Zostáva Vám " + a + " " + r + " ");
    }),
    ...
    (g.prototype.handleItemClick = function (e) {
      e.target.setAttribute("aria-current", "true");
    }),
    (g.prototype.setAriaLabel = function (e) {
      e.forEach(function (e) {
        e.classList.contains("idsk-crossroad__arria-hidden")
          ? (e.setAttribute("aria-hidden", "true"),
            u(e, "idsk-crossroad__arria-hidden"))
          : "true" == e.getAttribute("aria-hidden") &&
            (e.setAttribute("aria-hidden", "false"),
            u(e, "idsk-crossroad__arria-hidden"));
      });
    }),
    (g.prototype.handleShowItems = function (e) {
      ...
      t.forEach(function (e) {
        u(e, "idsk-crossroad__item--two-columns-show");
      }),
        this.setAriaLabel(n),
        this.setAriaLabel(o),
        (i.innerHTML =
          i.textContent == i.dataset.line1 ? i.dataset.line2 : i.dataset.line1),
        u(e.srcElement, "idsk-crossroad__colapse--button-show"),
        u(s, "idsk-crossroad__collapse--shadow"),
        u(s, "idsk-crossroad__collapse--arrow");
    }),
    (_.prototype.init = function () {
      ...
      (e.sendButtonDisabled = new Array(7)),
        ...
        e &&
          ...
          t &&
            t.addEventListener("click", this.handleNextButtonClick.bind(this)),
          i &&
            i.addEventListener(
              "click",
          ...
          s &&
            (e.textAreaMap.set("first", 1),
            s.addEventListener(
              "input",
              this.handleStatusOfCharacterCountButton.bind(this)
            )),
          n &&
            (e.textAreaMap.set("second", 2),
            n.addEventListener(
              "input",
              this.handleStatusOfCharacterCountButton.bind(this)
            )),
          o &&
            (e.textAreaMap.set("third", 4),
            o.addEventListener(
              "input",
              this.handleStatusOfCharacterCountButton.bind(this)
            )),
          r &&
            (e.textAreaMap.set("fourth", 5),
            r.addEventListener(
              "input",
              this.handleStatusOfCharacterCountButton.bind(this)
            )));
    }),
    (_.prototype.enableNextButtonForAllSteps = function (e) {
      for (var t = 0; t < this.$module.sendButtonDisabled.length; t++)
        this.$module.sendButtonDisabled[t] = !1;
    }),
    (_.prototype.handleStatusOfCharacterCountButton = function (e) {
      var t = this.$module,
        i = e.srcElement.id,
        s = t.querySelector("#" + i),
      ...
      setTimeout(function () {
        s.classList.contains("govuk-textarea--error") ||
        n.classList.contains("govuk-error-message")
          ? (o.disabled = !0)
          : ((o.disabled = !1),
            (t.sendButtonDisabled[t.textAreaMap.get(i)] = !1));
      }, 300);
    }),
    (_.prototype.handleCounterOfSubtitles = function (e) {
      var t,
        i = this.$module.querySelectorAll(".idsk-customer-surveys--subtitle");
      for (t = 0; t < e; t++)
        (i[t].textContent = i[t].textContent.substring(3)),
          (i[t].innerHTML = t + 1 + ". " + i[t].textContent);
    }),
    (_.prototype.handleRadioButtonWorkClick = function (e) {
      var t = this.$module.querySelector(
        ".idsk-customer-survey__text-area--work"
      );
      this.$module
        .querySelector(".idsk-customer-survey__subtitle--work")
        .classList.add("idsk-customer-surveys--subtitle"),
        t.classList.remove("idsk-customer-surveys--hidden"),
        this.handleCounterOfSubtitles.call(this, 8);
    }),
    (_.prototype.clearTextArea = function (e) {
      ...
      (t.value = ""),
        t.classList.contains("govuk-textarea--error") &&
          ...
          i.classList.remove("govuk-error-message"),
          i.classList.add("govuk-hint"),
          (i.innerHTML = e.dataset.lines));
    }),
    (_.prototype.handleRadioButtonPrivateClick = function (e) {
      var t = this.$module.querySelector(
          ".idsk-customer-survey__text-area--work"
        ),
    ...
    (_.prototype.handlePreviousButtonClick = function (e) {
      var t,
        i = this.$module,
      ...
      for (o.blur(), t = 1; t < s.length - 1; t++)
        if (
          (o.textContent == o.dataset.line2 &&
            ...
            u(r[0], "idsk-customer-surveys__icon--hidden"),
            (o.onclick = function () {
              location.href = "/";
            })),
          a.textContent.includes(a.dataset.line3) &&
            ((a.innerHTML = a.dataset.line2),
            u(r[0], "idsk-customer-surveys__icon--hidden")),
          ...
          return (
            ...
            u(s[t], "idsk-customer-surveys--hidden"),
            u(s[t - 1], "idsk-customer-surveys--hidden"),
            void s[t - 1].classList.add("idsk-customer-surveys--show")
          );
    }),
    (_.prototype.handleNextButtonClick = function (e) {
      var t = this.$module,
      ...
      if ((n.blur(), a.textContent.includes(a.dataset.line1))) {
        ...
        for (
          var l = t.querySelectorAll(".govuk-radios__input"), c = 0;
          c < l.length;
          c++
        )
          l[c].checked = !1;
        var d = t.querySelectorAll(".idsk-customer-surveys-text-area");
        for (c = 0; c < d.length; c++) this.clearTextArea.call(this, d[c]);
        this.enableNextButtonForAllSteps.call(this);
      }
      for (
        a.textContent.includes(a.dataset.line3) &&
          s.classList.add("idsk-customer-surveys--hidden"),
          c = 0;
        c < i.length - 1;
        c++
      )
        if (i[c].classList.contains("idsk-customer-surveys--show"))
          return (
            t.sendButtonDisabled[c + 1] ? (n.disabled = !0) : (n.disabled = !1),
            i[c].classList.remove("idsk-customer-surveys--show"),
            u(i[c], "idsk-customer-surveys--hidden"),
            u(i[c + 1], "idsk-customer-surveys--hidden"),
            i[c + 1].classList.add("idsk-customer-surveys--show"),
            4 == c &&
    ...
    (S.prototype.init = function () {
      var e = this.$module;
      if (e) {
        var t = e.querySelectorAll(".idsk-header-extended__search");
        t &&
          h(
            t,
            function (e) {
              e.addEventListener("change", this.handleSearchChange.bind(this)),
                e.dispatchEvent(new Event("change"));
            }.bind(this)
          );
        var i = e.querySelectorAll(".idsk-header-extended__language-button");
        if (i)
          h(
            i,
            function (e) {
        ...
        var s = e.querySelectorAll(".idsk-header-extended__link");
        s &&
          h(
            s,
            function (e) {
              e.addEventListener("click", this.handleSubmenuClick.bind(this)),
                e.addEventListener("focus", this.handleSubmenuClick.bind(this));
            }.bind(this)
          );
        var n = e.querySelector(".idsk-js-header-extended-side-menu"),
          o = e.querySelector(".idsk-header-extended__mobile-close");
        n &&
          o &&
          (n.addEventListener("click", this.showMobilMenu.bind(this)),
          o.addEventListener("click", this.hideMobilMenu.bind(this))),
          window.addEventListener("scroll", this.scrollFunction.bind(this)),
          (e.boundCheckBlurMenuItemClick =
            this.checkBlurMenuItemClick.bind(this)),
          (e.boundCheckBlurLanguageSwitcherClick =
            this.checkBlurLanguageSwitcherClick.bind(this));
      }
    }),
    (S.prototype.handleSearchChange = function (e) {
      var t = e.target || e.srcElement,
        i = t.closest(".idsk-header-extended__search").querySelector("label");
      t.value
        ? i.classList.add("idsk-header-extended__search-input--focus")
        : i.classList.remove("idsk-header-extended__search-input--focus");
    }),
    (S.prototype.handleLanguageSwitcherClick = function (e) {
      var t = e.target || e.srcElement;
      (this.$activeSearch = t.closest(".idsk-header-extended__language")),
        u(this.$activeSearch, "idsk-header-extended__language--active"),
    ...
    (S.prototype.checkBlurLanguageSwitcherClick = function () {
      this.$activeSearch.classList.remove(
        "idsk-header-extended__language--active"
      ),
    ...
    (S.prototype.handleSubmenuClick = function (e) {
      var t = (e.target || e.srcElement).closest(
          ".idsk-header-extended__navigation-item"
        ),
        i = this.$module.querySelectorAll(
          ".idsk-header-extended__navigation-item--active"
        );
      0 < i.length &&
        i[0].classList.remove("idsk-header-extended__navigation-item--active"),
        u(t, "idsk-header-extended__navigation-item--active"),
        document.addEventListener(
          "click",
    ...
    (S.prototype.checkBlurMenuItemClick = function () {
      this.$module
        .querySelectorAll(".idsk-header-extended__navigation-item--active")[0]
        .classList.remove("idsk-header-extended__navigation-item--active"),
        document.removeEventListener(
          "click",
          this.$module.boundCheckBlurMenuItemClick,
          !0
        ...
        if (t) {
          (this.$arrTitlesAndElems = []),
            t.forEach(
              function (e) {
                var t = {};
                (t.el = document.getElementById(e.href.split("#")[1])),
                  this.$arrTitlesAndElems.push(t),
                  e.addEventListener("click", this.handleClickLink.bind(this));
              }.bind(this)
            );
          var i = e.querySelector(".idsk-in-page-navigation__link-panel");
          i &&
            ((e.boundCheckCloseClick = this.checkCloseClick.bind(this)),
            (e.boundHandleClickLinkPanel =
              this.handleClickLinkPanel.bind(this)),
    ...
    (L.prototype.handleClickLink = function (e) {
      var t = e.target || e.srcElement,
        i = t.closest(".idsk-in-page-navigation__link").href.split("#")[1],
        s = this.$module.getElementsByClassName(
          "idsk-in-page-navigation__link-panel"
        )[0].offsetHeight;
      setTimeout(
        function () {
          null != document.getElementById(i)
            ? ((this.$module.labelChanged = !0),
              this.changeCurrentLink(t),
              window.scrollTo(
                0,
                document.getElementById(i).offsetTop - 2.5 * s
              ))
            : this.changeCurrentLink(t);
        }.bind(this),
        10
    ...
    (L.prototype.handleClickLinkPanel = function (e) {
      var t = this.$module,
        i = t.querySelector(".idsk-in-page-navigation__link-panel");
      t.classList.add("idsk-in-page-navigation--expand"),
        i.removeEventListener("click", t.boundHandleClickLinkPanel, !0),
        document.addEventListener("click", t.boundCheckCloseClick, !0);
    }),
    (L.prototype.checkCloseClick = function (e) {
      var t = (e.target || e.srcElement).closest(
      ...
      null == t &&
        (e.stopPropagation(),
        i.classList.remove("idsk-in-page-navigation--expand"),
        s.addEventListener("click", i.boundHandleClickLinkPanel, !0),
        document.removeEventListener("click", i.boundCheckCloseClick, !0));
    }),
    (L.prototype.scrollFunction = function () {
      var e = this.$module,
      ...
      if (
        (window.pageYOffset <= i
          ? e.classList.remove("idsk-in-page-navigation--sticky")
          : e.classList.add("idsk-in-page-navigation--sticky"),
        this.$module.labelChanged)
      )
        this.$module.labelChanged = !1;
        ...
        t.some(function (e, t) {
          if (
            e.el.offsetTop >= window.scrollY &&
            e.el.offsetTop <= window.scrollY + window.innerHeight
          )
            return n.changeCurrentLink(s[t]), !0;
        });
      } else this.changeCurrentLink(s[0]);
    }),
    (L.prototype.changeCurrentLink = function (e) {
      var t = this.$module,
    ...
    (E.prototype.init = function () {
      if (this.$module) {
        ...
        if (
          ...
          (t.subTopicButton = t.querySelector(
            ...
            if (i) {
              ...
              if (s) {
                ...
                if (i) {
                  ...
                  if (
                    s &&
                    ((t.resultCards = t.querySelectorAll(
                              ...
                              if (u) {
                                ...
                                if (h) {
                                  var p = t.querySelector("#datum-od"),
                                    m = t.querySelector("#datum-do"),
                                    f = t.querySelector(
                                      "#idsk-search-input__topic"
                                    );
                                  f &&
                                    f.addEventListener(
                                      "keyup",
                                      this.handleSearchItemsFromInput.bind(
                                        this,
                                        "radios"
                                      )
                                    );
                                  var k = t.querySelector(
                                  ...
                                  v &&
                                    ...
                                    p &&
                                      ...
                                      m.addEventListener(
                                        "focusout",
                                        this.handleFillDate.bind(this, "to")
                                      ),
                                      "" != m.value &&
                                        this.handleFillDate.call(
                                          this,
                                    ...
                                    l.addEventListener(
                                      "click",
                                      this.handleClickTurnFiltersOffButton.bind(
                                        this
                                      )
                                    ),
                                    c.addEventListener(
                                      "click",
                                      this.handleClickShowResultsButton.bind(
                                        this
                                      )
                                    ),
                                    d.addEventListener(
                                    ...
                                    e.addEventListener(
                                      "change",
                                      this.handleClickResultsPerPageDropdown.bind(
                                        this
                                      )
                                    ),
                                    ...
                                    u.forEach(
                                      function (e) {
                                        e.addEventListener(
                                          "click",
                                          this.handleClickRadioButton.bind(
                                            this
                                          ),
                                          !0
                                        ),
                                          e.checked &&
                                            this.handleClickRadioButton.call(
                                              this,
                                              e
                                            );
                                      }.bind(this)
                                    ...
                                    h.forEach(
                                      function (e) {
                                        e.addEventListener(
                                          "click",
                                          this.handleClickContentTypeCheckBox.bind(
                                            this
                                          ),
                                          !0
                                        ),
                                          e.checked &&
                                            this.handleClickContentTypeCheckBox.call(
                                              this,
                                              e
                                            );
                                      }.bind(this)
                                    ...
                                    this.handleClickShowResultsButton.call(
                                      this
                                    );
                                }
                              }
    ...
    (E.prototype.handleClickShowResultsButton = function (e) {
      var t = this.$module,
        ...
        c = t.querySelector(".idsk-search-results__content__page-changer"),
        d = t.querySelector(".idsk-search-results__content__all"),
        ...
        f = t.querySelector(".idsk-search-results__title"),
        k = document.getElementsByTagName("header"),
        v = document.getElementsByTagName("footer"),
        b = document.getElementsByClassName("govuk-breadcrumbs");
      f.classList.remove("idsk-search-results--invisible__mobile"),
        ...
        k[0] &&
          v[0] &&
          b[0] &&
          (k[0].classList.remove("idsk-search-results--invisible__mobile"),
          v[0].classList.remove("idsk-search-results--invisible__mobile"),
          b[0].classList.remove("idsk-search-results--invisible__mobile"));
    }),
    (E.prototype.handleSomeFilterPicked = function (e) {
      var t = this.$module,
      ...
      return (
        r
          ? i.classList.remove("idsk-search-results--invisible__mobile")
          : i.classList.add("idsk-search-results--invisible__mobile"),
        r
      );
    }),
    (E.prototype.handleCountForFiltersButton = function (e) {
      var t = this.$module,
    ...
    (E.prototype.handleClickTurnFiltersOffButton = function (e) {
      var t = this.$module,
        i = t.querySelector(".idsk-search-results__content"),
        s = t.querySelectorAll(".idsk-search-results__picked-topic"),
        n = t.querySelectorAll(".idsk-search-results__picked-content-type"),
    ...
    (E.prototype.handleClickFiltersButton = function (e) {
      var t = this.$module,
        i = t.querySelector(".idsk-search-results__filter"),
        s = t.querySelector(
          ".idsk-search-results .idsk-search-results__search-bar"
        ...
        k = document.getElementsByTagName("footer"),
        v = document.getElementsByClassName("govuk-breadcrumbs");
      this.handleSomeFilterPicked.call(this) &&
        (p.classList.remove("idsk-search-results--invisible"),
        h.classList.remove("idsk-search-results--invisible__mobile")),
        m.classList.add("idsk-search-results--invisible__mobile"),
        ...
        f[0] &&
          k[0] &&
          v[0] &&
          (f[0].classList.add("idsk-search-results--invisible__mobile"),
          k[0].classList.add("idsk-search-results--invisible__mobile"),
          v[0].classList.add("idsk-search-results--invisible__mobile")),
        a.classList.add("idsk-search-results--invisible");
    }),
    (E.prototype.handleClickPreviousPage = function (e) {
      var t = this.$module;
      (location.href = "#"),
        (t.currentPageNumber = t.currentPageNumber - 1),
        this.showResultCardsPerPage.call(
          this,
          t.countOfCardsPerPage * (t.currentPageNumber - 1),
          t.countOfCardsPerPage * t.currentPageNumber
        );
    }),
    (E.prototype.handleClickNextPage = function (e) {
      var t = this.$module;
      (location.href = "#"),
        (t.currentPageNumber = t.currentPageNumber + 1),
        this.showResultCardsPerPage.call(
    ...
    (E.prototype.handleClickResultsPerPageDropdown = function (e) {
      var t = e.target || e.srcElement;
      (this.$module.countOfCardsPerPage = t.value),
        this.showResultCardsPerPage.call(this, 0, t.value);
    }),
    (E.prototype.handleSearchItemsFromInput = function (t, e) {
      var i = e.target || e.srcElement,
        s = i
          .closest(".idsk-search-results__link-panel")
          .querySelectorAll(".govuk-" + t + "__item");
      s.forEach(
        function (e) {
        ...
        s.forEach(
          function (e) {
            e
              ...
              e.classList.add("idsk-search-results--invisible");
          }.bind(this)
        );
    }),
    (E.prototype.handleFillDate = function (e, t) {
      ...
      if (
        "" != i.value &&
        (i.value.match(/^(\d{1,2})\.(\d{1,2})\.(\d{4})$/) ||
          i.value.match(/^(\d{4})$/))
      ) {
        if (i.value && !o)
          var a = this.createTopicInContainer.call(
            this,
            n,
            i.id,
    ...
    (E.prototype.handleRemovePickedDate = function (e) {
      (e.target || e.srcElement || e).remove(),
        this.handleSomeFilterPicked.call(this),
        this.checkValuesInDateContainer.call(this),
        this.handleCountForFiltersButton.call(this),
        this.changeBackgroundForPickedFilters.call(this);
    }),
    (E.prototype.createSpanElement = function (e, t) {
      var i = document.createElement("span");
      return i.setAttribute("class", e), (i.innerHTML = t), i;
    }),
    (E.prototype.checkValuesInDateContainer = function (e) {
      var t = this.$module.querySelector(
          ".idsk-search-results__content__picked-filters__date"
        ),
      ...
      if (
        (n && n.remove(),
        o && o.remove(),
        t.querySelector('[data-source="datum-od"]') ||
          t.querySelector('[data-source="datum-do"]'))
      ) {
        if (
          t.querySelector('[data-source="datum-od"]') &&
          t.querySelector('[data-source="datum-do"]')
        ) {
          (n = this.createSpanElement.call(
            this,
            i,
            t.dataset.lines + " " + t.dataset.middle
          )),
            (o = this.createSpanElement.call(this, s, "a "));
          ...
          n = this.createSpanElement.call(
            this,
            i,
            t.dataset.lines + " " + t.dataset.after
          );
          t.insertBefore(n, t.querySelector('[data-source="datum-od"]'));
        } else if (t.querySelector('[data-source="datum-do"]')) {
          o = this.createSpanElement.call(
            this,
            s,
            t.dataset.lines + " " + t.dataset.before
          );
          t.insertBefore(o, t.querySelector('[data-source="datum-do"]'));
        }
      } else t.classList.add("idsk-search-results--invisible");
    }),
    (E.prototype.showResultCardsPerPage = function (e, t) {
      var i,
        s = this.$module,
        n = s.querySelector(".idsk-search-results__button--back"),
        o = s.querySelector(".idsk-search-results__button--forward"),
        r =
          (s.querySelector(".idsk-search-results__page-number"),
          s.querySelector(".idsk-search-results__button--back__mobile")),
      ...
      for (
        s.resultCards.forEach(
          function (e) {
            e.classList.contains("idsk-search-results--invisible") ||
              e.classList.add("idsk-search-results--invisible");
          }.bind(this)
        ),
          t >= s.resultCards.length
            ...
            : (o.classList.remove("idsk-search-results--hidden"),
              a.classList.remove("idsk-search-results--hidden")),
          e < 0
            ? (e = 0)
            : 0 < e
            ? (n.classList.remove("idsk-search-results--hidden"),
              r.classList.remove("idsk-search-results--hidden"))
            : 0 == e && (s.currentPageNumber = 1),
          i = e;
        i < t;
        i++
      )
      ...
      0 != e ||
        n.classList.contains("idsk-search-results--hidden") ||
        (n.classList.add("idsk-search-results--hidden"),
        r.classList.add("idsk-search-results--hidden"));
      var c = 1 + ((s.resultCards.length / s.countOfCardsPerPage) | 0),
        d = s.querySelector(".idsk-search-results__page-number span"),
        u = d.dataset.lines
          .replace("$value1", s.currentPageNumber)
          .replace("$value2", c);
      (d.innerText = u), (l.innerText = u);
    }),
    (E.prototype.handleClickLinkPanel = function (e) {
      ...
      u(
        t.querySelector(".idsk-search-results__list"),
        "idsk-search-results--hidden"
      ),
        u(t, "idsk-search-results--expand");
    }),
    (E.prototype.handleClickRadioButton = function (e) {
      var t = e.target || e.srcElement || e,
        i = this.$module,
        s = t
          .closest(".idsk-search-results__link-panel")
          .querySelector(".idsk-search-results__link-panel--span"),
        n = i.querySelector(
      ...
      if (t.value && !r) {
        var c = this.createTopicInContainer.call(
          this,
          n,
          o.dataset.id,
          a,
      ...
      } else if (r.dataset.source == o.dataset.id)
        (c = r).innerHTML = t.value + " &#10005;";
      else if (r.dataset.source != o.dataset.id)
        c = this.createTopicInContainer.call(this, n, o.dataset.id, a, t, !1);
      l.classList.remove("idsk-search-results--invisible__mobile"),
        ...
        c.addEventListener("click", this.handleRemovePickedTopic.bind(this)),
        this.changeBackgroundForPickedFilters.call(this),
        (s.innerText = "1 " + s.dataset.lines);
    }),
    (E.prototype.handleClickContentTypeCheckBox = function (e) {
      var t = e.target || e.srcElement || e,
        i = this.$module,
      ...
      r.classList.remove("idsk-search-results--invisible__mobile"),
        n.classList.remove("idsk-search-results--invisible"),
        this.handleCountOfPickedContentTypes.call(this, o, s),
        this.changeBackgroundForPickedFilters.call(this);
    }),
    (E.prototype.handleRemovePickedContentType = function (e) {
      var t = e.target || e.srcElement || e,
        i = this.$module.querySelector(
      ...
      (s.checked = !1),
        t.remove(),
        this.handleSomeFilterPicked.call(this),
        this.handleCountOfPickedContentTypes.call(this, i, n),
        this.handleCountForFiltersButton.call(this),
        this.changeBackgroundForPickedFilters.call(this);
    }),
    (E.prototype.handleCountOfPickedContentTypes = function (e, t) {
      var i = this.$module.querySelector(
          ".idsk-search-results__content__picked-filters__content-type"
        ),
      ...
      e &&
        ...
        0 == n
          ? ((s.innerText = ""),
            i.classList.add("idsk-search-results--invisible"))
          : (s.innerText = n + " " + s.dataset.lines);
    }),
    (E.prototype.createTopicInContainer = function (e, t, i, s, n) {
      var o = this.$module.querySelector(
          ".idsk-search-results__show-results__button"
        ),
        r = this.$module.querySelector(
          ".idsk-search-results__button--turn-filters-off"
        ),
        a = this.$module.querySelector(
    ...
    (E.prototype.changeBackgroundForPickedFilters = function (e) {
      var t = this.$module
        .querySelector(".idsk-search-results__content__picked-filters")
        .querySelectorAll("div:not(.idsk-search-results--invisible)");
      if (0 != t.length) {
        var i;
        for (
          t.forEach(
            function (e) {
              e.classList.remove("idsk-search-results--grey"),
                e.classList.remove("idsk-search-results--border");
            }.bind(this)
          ),
            i = 0;
          i < t.length;
    ...
    (E.prototype.disableSubtopic = function (e) {
      var t = this.$module.subTopicButton.parentElement.querySelector(
        ".idsk-search-results__list"
      );
      this.$module.subTopicButton.parentElement.classList.remove(
        "idsk-search-results--expand"
      ),
        t.classList.add("idsk-search-results--hidden"),
        this.$module.subTopicButton &&
          (this.$module.subTopicButton.disabled = !0);
    }),
    (E.prototype.handleRemovePickedTopic = function (e) {
      var t = e.target || e.srcElement || e,
        i = this.$module.querySelector(
          ".idsk-search-results__content__picked-filters__topics"
        );
      if ("tema" == t.dataset.source) {
        ...
        s
          ? this.removeTopic.call(this, s, !0)
          : this.$module.subTopicButton && this.disableSubtopic.call(this),
          i.classList.add("idsk-search-results--invisible");
      }
      this.removeTopic.call(this, t, !1);
    }),
    (E.prototype.removeTopic = function (e, t) {
      var i = this.$module.querySelector(
        '[data-id="' + e.dataset.source + '"]'
      );
      (i
        .closest(".idsk-search-results__link-panel")
        .querySelector(".idsk-search-results__link-panel--span").innerText =
        ""),
    ...
    (w.prototype.handleClickRadioButton = function (e) {
      (e.target || e.srcElement)
        .closest(".idsk-search-results__link-panel")
        .querySelector(".idsk-search-results__link-panel--span").innerText =
        "1 vybraté";
    }),
    (w.prototype.handleClickContentTypeCheckBox = function (e) {
      var t = e.target || e.srcElement,
    ...
    (w.prototype.handleCountOfPickedContentTypes = function (e, t) {
    ...
    (w.prototype.handleSearchItemsFromInput = function (t, e) {
      var i = e.target || e.srcElement,
        s = i
          .closest(".idsk-search-results__link-panel")
          .querySelectorAll(".govuk-" + t + "__item");
    ...
    (w.prototype.handleClickLinkPanel = function (e) {
      var t = (e.target || e.srcElement).closest(
        ".idsk-search-results__link-panel"
      );
      u(
      ...
      if (this.$module) {
        this.initControls(),
          ...
          s(
            this.$links,
            function (e) {
              e.addEventListener("click", this.handleItemLink.bind(this)),
                e.addEventListener("blur", this.handleItemLinkBlur.bind(this));
            }.bind(this)
          );
        var e = this.checkIfAllSectionsOpen();
        this.updateOpenAllButton(e);
    ...
    (q.prototype.initControls = function () {
    ...
    (q.prototype.initSectionHeaders = function () {
      s(
        this.$sections,
        function (e, t) {
          var i = e.querySelector("." + this.$sectionHeaderClass);
    ...
    (q.prototype.handleItemLink = function (e) {
      (e.target || e.srcElement)
        .closest(".idsk-stepper__section")
        .classList.add("idsk-stepper__bolder-line");
    }),
    (q.prototype.handleItemLinkBlur = function (e) {
      (e.target || e.srcElement)
        .closest(".idsk-stepper__section")
        .classList.remove("idsk-stepper__bolder-line");
    }),
    (q.prototype.initHeaderAttributes = function (t, e) {
      var i = this.$module,
        s = t.querySelector("." + this.$sectionButtonClass),
        n = t.querySelector("." + this.$sectionHeadingClass),
        o = t.querySelector("." + this.$sectionSummaryClass);
    ...
    (q.prototype.onSectionToggle = function (e) {
      var t = this.isExpanded(e);
      this.setExpanded(!t, e), this.storeState(e);
    }),
    (q.prototype.onOpenOrCloseAllToggle = function () {
      var t = this,
        e = this.$sections,
        i = !this.checkIfAllSectionsOpen();
      s(e, function (e) {
    ...
    (q.prototype.setExpanded = function (e, t) {
    ...
    (q.prototype.isExpanded = function (e) {
      return e.classList.contains(this.$sectionExpandedClass);
    }),
    (q.prototype.checkIfAllSectionsOpen = function () {
      return (
        this.$sections.length ===
        this.$module.querySelectorAll("." + this.$sectionExpandedClass).length
      );
    }),
    (q.prototype.updateOpenAllButton = function (e) {
      var t = this.$module.querySelector(".idsk-stepper__controls"),
        i = e ? t.dataset.line2 : t.dataset.line1;
      (i += '<span class="govuk-visually-hidden"> sections</span>'),
        this.$openAllButton.setAttribute("aria-expanded", e),
        (this.$openAllButton.innerHTML = i);
    });
  var i = {
    checkForSessionStorage: function () {
      var e,
  ...
  function T(e) {
    (this.$module = e),
      (this.moduleId = e.getAttribute("id")),
      (this.$sections = e.querySelectorAll(".govuk-accordion__section")),
      (this.browserSupportsSessionStorage = B.checkForSessionStorage()),
      (this.controlsClass = "govuk-accordion__controls"),
      (this.openAllClass = "govuk-accordion__open-all"),
      (this.iconClass = "govuk-accordion__icon"),
      (this.sectionHeaderClass = "govuk-accordion__section-header"),
  ...
  (q.prototype.storeState = function (e) {
    if (this.$browserSupportsSessionStorage) {
      var t = e.querySelector("." + this.$sectionButtonClass);
      if (t) {
        var i = t.getAttribute("aria-controls"),
    ...
    (q.prototype.setInitialState = function (e) {
      if (this.$browserSupportsSessionStorage) {
        var t = e.querySelector("." + this.$sectionButtonClass);
        if (t) {
          var i = t.getAttribute("aria-controls"),
    ...
    (x.prototype.handleSubmitClick = function (e) {
      e.preventDefault();
      var t = this.$module,
        i = t.querySelector(".idsk-registration-for-event__form"),
        s = t.querySelector(".idsk-registration-for-event__thank-you-msg"),
        n = t.querySelectorAll("[required]"),
        o = !0,
        r = /\S+@\S+\.\S+/;
      n.forEach(function (e) {
        var t = e.closest(".govuk-form-group");
        !e.checkValidity() || ("email" === e.type && !r.test(e.value))
          ? ((t.querySelector(".govuk-error-message").style.display = "block"),
            t.classList.add("govuk-form-group--error"),
            e.classList.add("govuk-input--error"),
            (o = !1))
          : ((t.querySelector(".govuk-error-message").style.display = "none"),
            t.classList.remove("govuk-form-group--error"),
            e.classList.remove("govuk-input--error"));
      }),
        o && ((s.style.display = "block"), (i.style.display = "none"));
    }),
    (A.prototype.init = function () {
      var e = this.$module;
      if (e) {
    ...
    (A.prototype.handleRadioButtonModeClick = function (e) {
      var t = e,
        i = this.$module;
      this.$currentMode !== t &&
        ("table" === (this.$currentMode = t)
          ? ((i.querySelector(".idsk-interactive-map__table").style.display =
              "block"),
            (i.querySelector(".idsk-interactive-map__map").style.display =
              "none"))
          : "map" === t &&
            ((i.querySelector(".idsk-interactive-map__map").style.display =
              "block"),
            (i.querySelector(".idsk-interactive-map__table").style.display =
              "none"),
            (i.querySelector(".idsk-interactive-map__map-iframe").src += "")));
    }),
    (A.prototype.renderData = function () {
      ...
      if (l) {
        var c = l.options[l.selectedIndex].value,
          d = l.options[l.selectedIndex].text;
        (e.querySelector(".idsk-interactive-map__current-indicator").innerText =
          d),
          (e.querySelector(
            ".idsk-interactive-map__current-time-period"
          ).innerText = a);
      }
      (s.src = n + "?indicator=" + c + "&time=" + r),
        (t.src = i + "?indicator=" + c + "&time=" + r);
    }),
    ($.prototype.init = function () {
      var e = this.$module;
      if (e) {
        var t = e.querySelectorAll(".idsk-graph__radio");
        t &&
          h(
            t,
            function (e) {
              e.addEventListener(
                "change",
                this.handleRadioButtonModeClick.bind(this)
              );
            }.bind(this)
          );
        var i = e.querySelector(".idsk-graph__copy-to-clickboard");
        i &&
          i.addEventListener(
            "click",
            this.handleShareByCopyToClickboardClick.bind(this)
          );
        var s = e.querySelector(".idsk-graph__send-link-by-email");
        s &&
          s.addEventListener("click", this.handleShareByEmailClick.bind(this));
        var n = e.querySelector(".idsk-graph__share-on-facebook");
        n && n.addEventListener("click", this.handleShareByFacebook.bind(this));
        var o = e.querySelectorAll(".idsk-graph__meta-link-list");
        o &&
          (h(
            o,
            function (e) {
              e.addEventListener(
                "click",
                this.handleDropdownLinkClick.bind(this)
              );
            }.bind(this)
          ),
          (e.boundCheckDropdownOutsideClick =
            this.checkDropdownOutsideClick.bind(this)));
        var r = e.querySelectorAll(".govuk-tabs__tab");
        if (r) {
          h(
            r,
            function (e) {
              e.addEventListener("click", this.handleTabLinkClick.bind(this));
            }.bind(this)
          );
          var a = e.querySelector(".govuk-tabs").dataset.activetab,
            l =
              e.querySelector(
                '.govuk-tabs__tab[href="' + window.location.hash + '"]'
              ) || r[a || 0];
          this.showTab(l);
        }
        var c = e.querySelector(".idsk-graph__radio").getAttribute("name"),
          d = e.querySelector('input[name="' + c + '"]:checked').value;
        this.handleRadioButtonModeClick(d);
      }
    }),
    ($.prototype.handleRadioButtonModeClick = function (e) {
      var t = e.target || e.srcElement;
      if (t) {
        var s = t.getAttribute("value");
        this.$module
          .querySelectorAll(".idsk-graph__iframe")
          .forEach(function (e) {
            var t = e.dataset.src,
              i = t.indexOf("?") < 0 ? "?type=" + s : "&type=" + s;
            e.src = t + i;
          });
      }
    }),
    ($.prototype.handleShareByCopyToClickboardClick = function (e) {
      e.preventDefault();
    ...
    ($.prototype.handleShareByEmailClick = function (e) {
      var t = e.target || e.srcElement,
        i = this.$module.querySelector(".idsk-graph__title h2").innerText,
        s =
          "mailto:?Subject=" + i + "&body=" + (i.dataset.lines + location.href);
      t.href = s;
    }),
    ($.prototype.handleShareByFacebook = function (e) {
      var t = e.target || e.srcElement,
        i = "https://www.facebook.com/sharer/sharer.php?u=" + location.href;
      t.href = i;
    }),
    ($.prototype.handleDropdownLinkClick = function (e) {
      e.preventDefault();
      var t = e.target || e.srcElement,
        i = this.$module,
        s = t
          .closest(".idsk-graph__meta-link-list")
          .parentElement.querySelector(".idsk-graph__meta-list"),
        n = window.getComputedStyle(s, null).display;
      i.querySelectorAll(".idsk-graph__meta-list").forEach(function (e) {
        e.style.display = "none";
      }),
        (s.style.display = "block" == n ? "none" : "block"),
        document.addEventListener(
          "click",
          this.$module.boundCheckDropdownOutsideClick,
          !0
        );
    }),
    ($.prototype.checkDropdownOutsideClick = function () {
      var e = this.$module;
      e.querySelectorAll(".idsk-graph__meta-list").forEach(function (e) {
        e.style.display = "none";
      }),
        document.removeEventListener(
          "click",
    ...
    ($.prototype.handleTabLinkClick = function (e) {
      e.preventDefault();
      var t = e.target || e.srcElement,
        i = this.$module,
        s = i.querySelector(".idsk-graph__section-show"),
        n = s.getAttribute("id"),
        o = i
          .querySelector('a[href="#' + n + '"]')
          .closest(".govuk-tabs__list-item");
      s.classList.remove("idsk-graph__section-show"),
        o.classList.remove("idsk-graph__section--selected"),
        this.showTab(t);
    }),
    ($.prototype.showTab = function (e) {
      var t = e.getAttribute("href"),
        i = t.slice(t.indexOf("#"), t.length),
        s =
          ((i = t.slice(t.indexOf("#"), t.length)),
          this.$module.querySelector(i));
      e
        .closest(".govuk-tabs__list-item")
        .classList.add("idsk-graph__section--selected"),
        s.classList.add("idsk-graph__section-show");
    }),
    ...
    (T.prototype.initHeaderAttributes = function (t, e) {
      var i = this,
        s = t.querySelector("." + this.sectionButtonClass),
        n = t.querySelector("." + this.sectionHeadingClass),
        o = t.querySelector("." + this.sectionSummaryClass),
  ...
  (T.prototype.storeState = function (e) {
    ...
    (e.initAll = function P(e) {
      var t =
        "undefined" != typeof (e = void 0 !== e ? e : {}).scope
          ? e.scope
          : document;
      s(t.querySelectorAll('[data-module="idsk-button"]'), function (e) {
        new k(e).init();
      }),
        s(t.querySelectorAll('[data-module="idsk-feedback"]'), function (e) {
          new v(e).init();
        }),
        s(
          t.querySelectorAll('[data-module="idsk-footer-extended"]'),
          function (e) {
            new b(e).init();
          }
        ),
        s(
          t.querySelectorAll('[data-module="idsk-character-count"]'),
          function (e) {
            new y(e).init();
          }
        ),
        s(t.querySelectorAll('[data-module="idsk-crossroad"]'), function (e) {
          new g(e).init();
        }),
        s(
          t.querySelectorAll('[data-module="idsk-customer-surveys"]'),
          function (e) {
            new _(e).init();
          }
        ),
        s(
          t.querySelectorAll('[data-module="idsk-header-extended"]'),
          function (e) {
            new S(e).init();
          }
        ),
        new L(
          t.querySelector('[data-module="idsk-in-page-navigation"]')
        ).init(),
        new E(t.querySelector('[data-module="idsk-search-results"]')).init(),
        s(
          t.querySelectorAll('[data-module="idsk-search-results-filter"]'),
          function (e) {
            new w(e).init();
          }
        ),
        s(
          t.querySelectorAll('[data-module="idsk-search-component"]'),
          function (e) {
            new C(e).init();
          }
        ),
        s(t.querySelectorAll('[data-module="idsk-stepper"]'), function (e) {
          new q(e).init();
        }),
        s(
          t.querySelectorAll('[data-module="idsk-registration-for-event"]'),
          function (e) {
            new x(e).init();
          }
        ),
        s(
          t.querySelectorAll('[data-module="idsk-interactive-map"]'),
          function (e) {
            new A(e).init();
          }
        ),
        s(t.querySelectorAll('[data-module="idsk-graph"]'), function (e) {
          new $(e).init();
        }),
        s(t.querySelectorAll('[data-module="idsk-accordion"]'), function (e) {
          new T(e).init();
        }),
        (function i(e) {
          var t =
            "undefined" != typeof (e = void 0 !== e ? e : {}).scope
              ? e.scope
              : document;
          h(t.querySelectorAll('[data-module="govuk-button"]'), function (e) {
            new o(e).init();
          }),
            h(
              t.querySelectorAll('[data-module="govuk-accordion"]'),
              function (e) {
                new n(e).init();
              }
            ),
            ...
            new d(
              t.querySelector('[data-module="govuk-error-summary"]')
            ).init(),
            new p(t.querySelector('[data-module="govuk-header"]')).init(),
            h(t.querySelectorAll('[data-module="govuk-radios"]'), function (e) {
              new m(e).init();
            }),
            h(t.querySelectorAll('[data-module="govuk-tabs"]'), function (e) {
              new f(e).init();
            });
        })(e);
    }),
    ...
    (e.FooterExtended = b),
    (e.HeaderExtended = S),
    (e.InPageNavigation = L),
    (e.SearchComponent = C),
    (e.SearchResults = E),
    (e.SearchResultsFilter = w),
    (e.RegistrationForEvent = x),
    (e.InteractiveMap = A),
    (e.Stepper = q),
    (e.Graph = $),
    (e.Accordion = T);
